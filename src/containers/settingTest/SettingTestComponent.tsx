...
import { ISettingTestComponentProps } from './ISettingTestComponentProps'
import { ISettingTestComponentState } from './ISettingTestComponentState'
 ...
 * @extends {Component}
 */
export class SettingTestComponent extends Component<ISettingTestComponentProps,ISettingTestComponentState> {

  /**
   * Component constructor
   * @param  {object} props is an object properties of component
   */
  constructor (props: ISettingTestComponentProps) {
    super(props)
      ...
      <Grid container spacing={24}>
        ...
        <div className='animate-bottom'>
          <Paper className={classes.paper} elevation={1} >
            <div style={{ padding: '480px 40px 36px' }}>
              <div style={{
                paddingLeft: '40px',
                paddingRight: '40px'
              }}>
 ...
 */
const mapDispatchToProps = (dispatch: any, ownProps: ISettingTestComponentProps) => {
  return {
 ...
 * @return {object}          props of component
 */
const mapStateToProps = (state: any, ownProps: ISettingTestComponentProps) => {
  return {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(styles as any)(SettingTestComponent as any) as any) as any)
